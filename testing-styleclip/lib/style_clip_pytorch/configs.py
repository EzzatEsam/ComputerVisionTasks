...
class PATH_CONFIGS:
    ...
    """
    def __init__(self): 
        self.e4e = PRETRAINED_MODELS_PATH / 'e4e_ffhq_encode.pt'
        self.stylegan2_ada_ffhq = PRETRAINED_MODELS_PATH / 'ffhq.pkl'
        self.ir_se50 = PRETRAINED_MODELS_PATH / 'model_ir_se50.pth'
        self.dlib = PRETRAINED_MODELS_PATH / 'shape_predictor_68_face_landmarks.dat'
